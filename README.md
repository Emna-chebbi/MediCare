# 🏥 MediCare — Medical Office Management System (Spring Boot + MySQL)

**MediCare** is a web-based medical office management system built using **Spring Boot** and a **standalone MySQL database**. It provides a secure and role-specific interface for managing appointments, consultations, and doctor-patient interactions in a digital healthcare environment.
